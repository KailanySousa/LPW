...
INSERT INTO `tbl_atividade` VALUES (1,'Ator'),(2,'Músico'),(3,'Produtor'),(4,'Cineasta'),(5,'Roteirista'),(6,'Diretor'),(7,'Modelo'),(8,'Camera');
...
INSERT INTO `tbl_atividade_ator` VALUES (1,6,1),(2,6,2),(3,6,3),(4,6,4),(5,1,3),(6,1,1),(7,4,1),(8,4,5),(9,4,6),(10,4,3),(11,10,1),(12,3,1),(13,3,6),(14,3,3),(15,8,7),(16,8,1),(17,8,6),(18,8,3),(19,5,1),(20,7,1),(21,7,3),(22,14,1),(23,15,1);
...
INSERT INTO `tbl_ator` VALUES (1,'Sandra Bullock','Sandra Annette Bullock','6b5fcf2867a7e98fd116b6c520df39d3.jpg','1964-07-26',1,0,2),(3,'Jennifer Aniston','Jennifer Joanna Aniston','97a518b76819e49caa2c9a9a70185bff.jpg','1969-02-11',1,0,2),(4,'Kelly Overton','Kelly Overton','f1848ba4327ec44a5111f27fb3b18d87.jpg','1978-08-28',1,0,2),(5,'Lana Parrila','Lana Maria Parrila','b0759535bd90fee23bff0c823235aa79.jpg','1977-07-15',1,0,2),(6,'Jhonny Depp','John Christopher Depp II','357d89e05faec29e050a5702b5a8af53.jpg','1963-07-09',1,0,2),(7,'Gerard Butler','Gerard James Butler','51599f456dfd8a612b83aea0ff5eeb4c.jpg','1969-11-13',1,0,3),(8,'Jennifer Morrison','Jennifer Marie Morrison','7e83af8afb02847162ad2657cae948ab.jpg','1979-04-12',1,0,2),(10,'Rodrigo Santoro','Rodrigo Junqueira Reis Santoro','7b7596c3cde4d05a2c234190e0ebcf50.jpg','1975-08-22',1,0,1),(14,'Dwayne Johnson','Dwayne Douglas Johnson','50adfadb07f8b5c9d6cc6e29806de957.jpg','1972-05-02',1,0,2),(15,'Kailany','Kailany Sousa','5c2da7d2c5537a67eff8d2247a981ecd.jpg','2002-10-24',1,0,1),(16,'teste','teste','68cb9c05c49476fb3bd0a2e3695768ac.png','2001-01-18',1,0,1),(17,'Testte','resrts','7520c6e91140b69ca8b270cec72bdf68.png','1957-10-25',0,0,1);
...
INSERT INTO `tbl_classificacao` VALUES (1,'Livre','img/livre.png'),(2,'10','img/dez_anos.png'),(3,'12','img/doze_anos.png'),(4,'14','img/quatorze_anos.png'),(5,'16','img/dezesseis_anos.png'),(6,'18','img/dezoito_anos.png');
...
INSERT INTO `tbl_diretor` VALUES (1,'Joe Russo'),(7,'Andy Tennant');
...
CREATE TABLE `tbl_filme` (
  ...
  `legendado` tinyint(4) DEFAULT NULL,
...
INSERT INTO `tbl_filme` VALUES (8,'Caçador de Recompensas','0bbc9177db7856e143abfcb0991cb6f8.jpg',2,'180 minutos','Milo Boyd é um ex-policial que se tornou caçador de recompensas. Sua missão é prender a repórter Nicole, que também é sua ex-esposa. Ele acaba descobrindo que tem mais gente atrás dela em função de uma reportagem sobre um possível assassinato. Os dois ficam na mira dos criminosos e decidem se juntar para escapar do perigo.',1,1,'20,00',2,2010,'https://www.youtube.com/embed/6D9VRhjIVgc',5,1,1);
...
INSERT INTO `tbl_filme_ator` VALUES (6,8,3),(7,8,7);
...
INSERT INTO `tbl_filme_diretor` VALUES (6,7,8);
...
CREATE TABLE `tbl_filme_genero` (
  ...
  KEY `fk_filme_genero_filme_idx` (`cod_filme`),
  KEY `fk_filme_genero_genero_idx` (`cod_genero`),
  CONSTRAINT `fk_filme_genero_filme` FOREIGN KEY (`cod_filme`) REFERENCES `tbl_filme` (`cod_filme`),
  CONSTRAINT `fk_filme_genero_genero` FOREIGN KEY (`cod_genero`) REFERENCES `tbl_genero` (`cod_genero`)
...
INSERT INTO `tbl_pais` VALUES (1,'Brasil'),(2,'Estados Unidos'),(3,'Reino Unido'),(4,'Cuba');
...
INSERT INTO `tbl_promocao` VALUES (2,'10',8,1);
...
INSERT INTO `tbl_usuario` VALUES (8,'Kailany 2','kailany-sousa@gmail.com','202cb962ac59075b964b07152d234b70',1,9),(9,'Ayla','ayla-sousa@gmail.com','d41d8cd98f00b204e9800998ecf8427e',0,9),(10,'Maria 2','maria-sousa@gmail.com','8dfdbff5d6132ae4222168fc620197ac',1,9),(11,'asasa 222','teste@vc.com','d41d8cd98f00b204e9800998ecf8427e',0,9),(12,'teste','teste@vc.com','d41d8cd98f00b204e9800998ecf8427e',0,9);
...
-- Dump completed on 2019-05-07 10:47:35
