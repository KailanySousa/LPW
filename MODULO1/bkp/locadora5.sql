...
CREATE TABLE IF NOT EXISTS `db_locadora`.`tbl_ator` (
  ...
  INDEX `fk_ator_pais_idx` (`cod_pais` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 15
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `db_locadora`.`tbl_atividade_ator` (
  ...
  INDEX `fk_tbl_atividade_ator_tbl_ator1_idx` (`cod_ator` ASC) VISIBLE,
  INDEX `fk_tbl_atividade_ator_tbl_atividade1_idx` (`cod_atividade` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_locadora`.`tbl_cidade` (
  ...
  INDEX `cod_estado` (`cod_estado` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_locadora`.`tbl_filme` (
  ...
  INDEX `fk_tbl_filme_tbl_pais1_idx` (`cod_pais` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_locadora`.`tbl_filme_ator` (
  ...
  INDEX `fk_tbl_filme_ator_tbl_filme1_idx` (`cod_filme` ASC) VISIBLE,
  INDEX `fk_tbl_filme_ator_tbl_ator1_idx` (`cod_ator` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_locadora`.`tbl_filme_diretor` (
  ...
  INDEX `fk_tbl_filme_diretor_tbl_diretor1_idx` (`cod_diretor` ASC) VISIBLE,
  INDEX `fk_tbl_filme_diretor_tbl_filme1_idx` (`cod_filme` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `db_locadora`.`tbl_promocao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_locadora`.`tbl_promocao` (
  `cod_promocao` INT(11) NOT NULL AUTO_INCREMENT,
  `percentual_desconto` VARCHAR(45) NOT NULL,
  `cod_filme` INT(11) NOT NULL,
  PRIMARY KEY (`cod_promocao`),
  INDEX `fk_promocao_filme_idx` (`cod_filme` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `db_locadora`.`tbl_sobre`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_locadora`.`tbl_sobre` (
...
CREATE TABLE IF NOT EXISTS `db_locadora`.`tbl_usuario` (
  ...
  INDEX `fk_usuario_nivel` (`cod_nivel` ASC) VISIBLE,
