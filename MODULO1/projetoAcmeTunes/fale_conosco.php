                    ...
                    <div id="dados-usuario" class="center">
                        ...
                        <div id="formulario" class="center">
                            ...
                            <form name="frm-fale-conosco" method="post" action="fale_conosco.php">
                                ...
                                <input id="txt-nome" class="style-input" type="text" name="txt-nome" value="" required placeholder="Nome" onkeypress="return validarLetra(event);"/>
                                
                                <input id="profissao" class="style-input" type="text" name="txt-profissao" value="" required placeholder="Profissão" onkeypress="return validarLetra(event);"/>
                                ...
                                <div id="caixa-telefone">
                                    <input class="telefone style-input" type="tel" name="txt-telefone" id="txt-telefone" value="" placeholder="Telefone" pattern="^[(]\d{2}[)]\d{4}-\d{4}$" onkeypress="return validarNumero(event);"/>
                                    
                                    <input class="telefone style-input" style="margin-left: 8px;" type="tel" name="txt-celular" id="txt-celular" value="" required placeholder="Celular" pattern="^[(]\d{2}[)]\d{5}-\d{4}$" onkeypress="return validarNumero(event);">
                                </div>
