 <div id="slider">
                 <div style="opacity: 1;margin-top: 80px;" class="swiper-container main-slider loading">
                    ...
                    <div style="margin-top: 80px;" class="swiper-container nav-slider loading">
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <figure class="slide-bgimg" style="background-image:url(https://drive.google.com/uc?export=view&id=0B_koKn2rKOkLbVhsNzdIYmlfN1E)">
                            <img src="https://drive.google.com/uc?export=view&id=0B_koKn2rKOkLbVhsNzdIYmlfN1E" class="entity-img" />
                 ...
                 <div id="redes-socias">
                <div class="icones center"> <img src="img/facebook.png"> </div>
                <div class="icones center"> <img src="img/instagram.png"></div>
                <div class="icones center"> <img src="img/twitter.png"></div>
            </div>
</div>